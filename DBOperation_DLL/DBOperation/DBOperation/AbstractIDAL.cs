...
{
    #region AbstractIDAL
    public abstract class AbstractIDAL
    {
        protected string connString = System.Configuration.ConfigurationManager.ConnectionStrings["connection"].ToString();
        /// <summary>
        /// 检查是否已经存在
        /// </summary>
        /// <remarks>
        ...
        public abstract int Exists<T>(T count, string tableName, string countName);
        /// <summary>
        /// 向数据库插入一条数据
        /// </summary>
        /// <remarks>
        ...
        public abstract int AddModel<T>(T model);
        /// <summary>
        /// 向数据库更新一条/多条？数据
        /// </summary>
        /// <remarks>
        ...
        /// <returns>返回数据库中受影响的行数？</returns>0
        public abstract int UpdateModel<T>(T model, string[] countName);
        /// <summary>
        /// 向数据库删除一条/多条？数据
        /// </summary>
        /// <remarks>
        ...
        public abstract int DeleteModel<T>(T mdoel, string[] countName);
        /// <summary>
        ...
        public abstract DataSet SelectList<T>(T model, string[] countName);
        /// <summary>
        ...
        public abstract DataSet SelectList<T>(T model, string[] countName, int top);//TODO:SelectList need TEST
        /// <summary>
        ...
        public abstract DataSet SelectRow<T>(T model, string[] countName);// TODO:SelectRow need TEST once
        /// <summary>
        ...
        public abstract DataSet SelectRow<T>(T model, string[] countName, int top);

        public abstract DataSet SelectRow<T, M>(T model, DALTools<M>[] range);//TODO:SelectRow need TEST

        public abstract DataSet SelectRow<T, M>(T model, DALTools<M>[] range, int top);
        /// <summary>
        ...
        public abstract DataSet SelectField<T>(T model, string[] premiseFieldName, string[] aimFieldName);//TODO:SelectField need TEST
        /// <summary>
        ...
        public abstract DataSet SelectField<T>(T model, string[] premiseFieldName, string[] aimFieldName, int top);//TODO:SelectField need TEST

        public abstract DataSet SelectField<T, M>(T model, DALTools<M>[] range, string[] aimFieldName);

        public abstract DataSet SelectField<T, M>(T model, DALTools<M>[] range, string[] aimFieldName, int top);
        //where区间查询
        //获取某项数据总数
        /// <summary>
        /// 获取满足where条件的前top行若干字段
        ...
        /// <param name="aimFieldName">sql语句中要查询的字段</param>
        /// <returns>返回前top行满足premiseFieldName字段条件的aimFieldName字段的参数</returns>
        public abstract int MostID<T>(T model, string countName);//TODO:MostID need TEST
    }
    #endregion
